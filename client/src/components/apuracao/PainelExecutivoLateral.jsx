/**
 * Painel lateral esquerdo (desktop) — "Apuração Nacional/Estadual".
 * Sempre mostra Presidente e Governador, independente da aba ativa no topo.
 * Clicar num candidato:
 * - troca a aba ativa para o cargo dele (presidente ou governador)
            ...
            return (
              <button
                ...
                className={`w-full text-left rounded-lg transition-colors ${
                  ativo ? 'bg-slate-50 -mx-2 px-2 py-1' : ''
                }`}
              >
