...
export default function SistemaPolitico() {
    const [estadoSelecionado, setEstadoSelecionado] = useState<string | null>("SP");
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-white border-b sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        />
                        <span className="font-bold text-xl text-gray-800 hidden sm:block">XDENKER</span>
                    </div>
                ...
                <nav className="flex overflow-x-auto border-t">
                    {["Visão Geral", "Executivo Federal", "Senado", "Câmara dos Deputados", "Assembleias Estaduais"].map((tab, i) => (
                        <button
                            key={tab}
                            className={`px-5 py-3 text-sm font-medium whitespace-nowrap border-b-2 transition-colors ${i === 0
            ...
            <main className="max-w-7xl mx-auto px-4 py-6 space-y-8">
                ...
                <section className="bg-white rounded-2xl shadow-sm border p-5">
                    <h2 className="text-lg font-bold text-gray-800 mb-4">Executivo Federal</h2>
                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="flex-1">
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                {["Fernando Haddad", "Flávio Dino", "Simone Tebet", "Alexandre Padilha", "Rui Costa", "Camilo Santana"].map((nome) => (
                                    <div key={nome} className="border rounded-lg p-3 flex items-center gap-3 hover:bg-gray-50 cursor-pointer">
                ...
                {/* Barra de Espectro Executivo + Legislativo */}
                <section className="bg-white rounded-2xl shadow-sm border p-5">
                    <h2 className="text-lg font-bold text-gray-800 mb-4">Espectro Geral do Poder</h2>

                    <div className="space-y-4">
                        <div>
                            <div className="text-sm font-medium text-gray-600 mb-1">Executivo (Presidência + Governadores)</div>
                        ...
                        <div>
                            <div className="text-sm font-medium text-gray-600 mb-1">Legislativo (Senado + Câmara + Assembleias)</div>
                            <div className="h-8 rounded-full overflow-hidden flex">
                ...
                <section className="bg-white rounded-2xl shadow-sm border p-5">
                    <h2 className="text-lg font-bold text-gray-800 mb-4">Assembleias Estaduais</h2>
