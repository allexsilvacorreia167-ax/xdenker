            ...
            <div className="flex flex-wrap gap-1.5 md:gap-2">
              {estados.map((uf) => (
                <button
                  ...
                  className={
                    "px-3 py-1.5 rounded-xl text-xs md:text-sm font-medium transition-colors " +
          ...
          <section className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 md:p-6">
            ...
            {loading ? (
              ...
              <Hemiciclo
                ...
                totalLabel={String(deputados.length)}
                height={220}
                maxArcos={7}
          ...
          <section className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 md:p-6">
            ...
            {loading ? (
              <div className="border border-slate-200 rounded-xl p-8 text-center text-slate-400 text-sm">
                Carregando deputados estaduais...
              </div>
                        ...
                        <div className="text-xs text-slate-500 truncate">
                          ...
                          {p.espectro && (
                            <span
                              ...
                              style={{
                                background: spectrumColors[p.espectro] || "#999",
                              }}
                            />
                          )}
                        </div>
              ...
              <div className="border border-dashed border-slate-200 rounded-xl p-8 text-center text-slate-400 text-sm">
                Nenhum deputado estadual encontrado para {estadoSelecionado}.
              </div>
            )}
          </section>
        </div>
