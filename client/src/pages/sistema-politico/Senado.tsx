...
export default function Senado() {
  ...
  const temFiltro =
    busca.trim().length > 0 || filtroEspectro !== "Todos os espectros";
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 md:p-6">
            ...
            {loading ? (
              ...
              <Hemiciclo
                politicos={senadores}
                destaqueIds={temFiltro ? senadoresFiltrados.map((p) => p.id) : []}
                label="SENADO"
                totalLabel={String(senadores.length || 81)}
                height={240}
          ...
          <section className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 md:p-6">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-5">
              ...
              <div className="flex flex-wrap gap-2 w-full md:w-auto">
                <input
                  type="text"
                  placeholder="Buscar senador, partido ou UF..."
                  value={busca}
