...
// GET /api/tse/candidatos?year=2022&uf=BR&cargo=presidente
router.get('/candidatos', getCandidates);

// GET /api/tse/buscar?q=silva&uf=CE&cargo=deputado_federal&year=2022
router.get('/buscar', searchCandidates);

// GET /api/tse/candidato/:id?year=2022
